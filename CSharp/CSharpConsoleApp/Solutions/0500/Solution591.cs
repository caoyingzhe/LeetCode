...
{
    /*
    * @lc app=leetcode.cn id=591 lang=csharp
    *
    * [591] 标签验证器
    *
    ...
    */
    public class Solution591 : SolutionBase
    {
        /// <summary>
        /// 难度
        /// </summary>
        ...
        public override bool Test(System.Diagnostics.Stopwatch sw)
        {
            ...
            s = "<DIV> unmatched tags with invalid tag name  <ABCDEFG></ABCDEFG> and <![CDATA[ X-Y-Z ]]>  </DIV>";
            checkResult = true;
            result = IsValid(s);
            isSuccess &= IsSame(result, checkResult);
            PrintResult(isSuccess, result, checkResult);

            s = "<DIV>  unmatched start tag <C>  and unmatched end tag </C>  </DIV>";
            checkResult = true;
            result = IsValid(s);
            isSuccess &= IsSame(result, checkResult);
            PrintResult(isSuccess, result, checkResult);
        ...
        //作者：LeetCode
        //链接：https://leetcode-cn.com/problems/tag-validator/solution/biao-qian-yan-zheng-qi-by-leetcode/
        Stack<string> stack = new Stack<string>();
        bool contains_tag = false;

        /// <summary>
        /// 259/259 cases passed (72 ms)
        /// Your runtime beats 100 % of csharp submissions
        /// Your memory usage beats 100 % of csharp submissions(23.1 MB)
        /// </summary>
