...
namespace CSharpConsoleApp.Solutions
{
    ...
    public class Solution638 : SolutionBase
    {
        /// <summary>
        /// 难易度:
        /// </summary>
        ...
        /// 标签： 
        /// </summary>
        public override Tag[] GetTags() { return new Tag[] { Tag.DynamicProgramming, Tag.DepthFirstSearch }; }
        ...
        public int DFS(IList<int> price, IList<IList<int>> special, IList<int> needs)
        {
            ...
            foreach (List<int> item in special)
            {
                List<int> clone = new List<int>(needs);
                int j;
                ...
                if (j == needs.Count)
                {
                    res = Math.Min(res, item[j] + DFS(price, special, clone));
                }
            }
            return res;
        }
