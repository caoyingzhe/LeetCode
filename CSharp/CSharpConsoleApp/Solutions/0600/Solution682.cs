 ...
 */
    ...
    // @lc code=start
    public class Solution682 : SolutionBase
    {
        /// <summary>
        /// 难度
        /// </summary>
        ...
        /// <summary>
        /// 39/39 cases passed (104 ms)
        /// Your runtime beats 83.72 % of csharp submissions
        /// Your memory usage beats 25.58 % of csharp submissions(24.4 MB)
        /// </summary>
        ...
        public int CalPoints(string[] ops)
        {
            ...
            int ans = 0;
            foreach (int score in stack) ans += score;
            return ans;
        }
    }
    // @lc code=end
